            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div>
                ...
                <input
                  ...
                  id="email"
                  className=" border  sm:text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                  placeholder="demat account info"
                  required
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                className="w-full text-white  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center  focus:ring-primary-800"
              >
                Create an account
              </button>
